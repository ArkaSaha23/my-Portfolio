    ...
    <div className="mt-5 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
      <div className="mt-4 space-y-4 text-center font-mono text-sm md:text-lg transition-all duration-300">
        ...
        <p>
          ...
          <a href="./Arka_Saha_Resume.pdf" download className="mt-4 inline-block bg-blue-500 text-white px-6 py-2 rounded-lg shadow-md hover:bg-blue-600 transition-colors duration-300 font-mono">
            Download Resume
          </a>  
